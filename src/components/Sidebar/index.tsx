    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <g fill="currentColor">
              <path d="M4 2C3.44772 2 3 2.44772 3 3V21C3 21.5523 3.44772 22 4 22H20C20.5523 22 21 21.5523 21 21V3C21 2.44772 20.5523 2 20 2H4ZM19 20H17V18H19V20ZM19 16H17V14H19V16ZM19 12H17V10H19V12ZM19 8H17V6H19V8ZM14 20H12V18H14V20ZM14 16H12V14H14V16ZM14 12H12V10H14V12ZM14 8H12V6H14V8ZM9 20H7V18H9V20ZM9 16H7V14H9V16ZM9 12H7V10H9V12ZM9 8H7V6H9V8ZM4 6H6V8H4V6ZM4 10H6V12H4V10ZM4 14H6V16H4V14ZM4 18H6V20H4V18ZM8 4H16V6H8V4Z" />
              <path d="M5 14H2V16H1V18H2V19H5V18H6V16H5V14ZM5 16H4V15H5V16ZM10 14H8V16H6V17H8V18H10V17H12V16H10V14ZM16 14H14V16H12V17H14V18H16V17H18V16H16V14ZM19 18H20V16H19V14H17V16H18V18H19Z" />
            </g>
          </svg>
        ),
        label: "Stages",
...

      {
        icon: (
          ...
          >
            <path
              d="M18 6H6c-1.1 0-2 .9-2 2v4.14l-2.72 4.83c-.15.28-.28.58-.28.87v.65c0 1.1.9 2 2 2h1.09c.68 0 1.33-.37 1.66-.96l1.4-2.62h8.58l1.39 2.62c.34.59.98.96 1.66.96h1.09c1.1 0 2-.9 2-2v-.65c0-.29-.12-.59-.28-.87L20 12.14V8c0-1.1-.9-2-2-2zm-1.5 10h-1v-1h1v1zm-4-2H9v-1h4v1zm1.5 2h-1v-1h1v1zM6 10h12v2H6v-2zm0-4h12v2H6V6z"
              fill="currentColor"
            />
          </svg>
        ),
