...
const AddSections = ({ closeModal, modal, onSectionsAdded }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Client added successfully:', newSections);
            onSectionsAdded(newSections); // Pass the new client data to the parent component
