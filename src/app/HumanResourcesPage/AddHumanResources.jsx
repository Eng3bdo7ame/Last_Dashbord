...
const AddHumanResources = ({ closeModal, modal, onHumanResourcesAdded }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const newHumanResources = response.data;
            console.log('Client added successfully:', newHumanResources);
            onHumanResourcesAdded(newHumanResources); // Pass the new client data to the parent component
